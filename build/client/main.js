...
App = /*#__PURE__*/function (_React$Component) {_inherits(App, _React$Component);function App() {_classCallCheck(this, App);return _possibleConstructorReturn(this, _getPrototypeOf(App).apply(this, arguments));}_createClass(App, [{ key: "render", value: function render()
    {
      return (
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_form_form__WEBPACK_IMPORTED_MODULE_2__["default"], null)));
...
var cx = classnames__WEBPACK_IMPORTED_MODULE_1___default.a.bind(_style_scss__WEBPACK_IMPORTED_MODULE_2___default.a);
...
Form = /*#__PURE__*/function (_React$Component) {_inherits(Form, _React$Component);
  ...
  function Form() {var _this;_classCallCheck(this, Form);
    ...
    _this.state = {
      clicked: false,
      cardNumber: 0 };return _this;

  }_createClass(Form, [{ key: "clickLeftHandler", value: function clickLeftHandler()

    {var _this$State =
      this.State,clicked = _this$State.clicked,cardNumber = _this$State.cardNumber;
      if (cardNumber > 0) {
        this.setState({ clicked: !clicked, cardNumber: cardNumber - 1 });
      }
    } }, { key: "clickHandler", value: function clickHandler()

    {var
      clicked = this.State.clicked;
      this.setState({ clicked: !clicked });
    } }, { key: "clickRightHandler", value: function clickRightHandler()
    ...
    {var _this2 = this;
      ...
      return (
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null,
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", { className: display }, this.state.clicked ? cards[this.state.cardNumber].answer : cards[this.state.cardNumber].question),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { onClick: function onClick() {_this2.clickLeftHandler();} }, "Previous"),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { onClick: function onClick() {_this2.clickHandler();} }, "Answer"),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { onClick: function onClick() {_this2.clickRightHandler();} }, "Next"),
